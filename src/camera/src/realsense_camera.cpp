...
void NormalCamera::InitParam() {
    ...
    this->set_parameter(rclcpp::Parameter("frame_height", _config_yaml["frame_height"].as<int>()));
    this->get_parameter("frame_height", _config.frame_height);

    this->declare_parameter<int>("fps", 30);
    this->set_parameter(rclcpp::Parameter("fps", _config_yaml["fps"].as<int>()));
